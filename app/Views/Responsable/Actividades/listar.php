                        ...
                        <?php foreach($actividades as $key => $actividad) : ?>
                            <tr>
                                ...
                                <td style="width:8%;">  
                                    ...
                                    <a class="btn btn-warning btn-sm btn-block mb-0" href="<?= base_url("responsables/asistencia/$actividad->id_actividad") ?>"><i class="fas fa-file-pdf"></i> (PDF) Lista de asistencia</a>
                                    <a class="btn btn-secondary btn-sm btn-block mb-0" href="<?= base_url("responsables/alumnos/listas/") ?>"><i class="fas fa-file-alt"></i> Acta de calificaciones</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach ?>
