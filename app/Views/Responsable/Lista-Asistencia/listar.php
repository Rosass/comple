   ...
   <body>
      ...
      <footer>
         <div> 
            ...
            <?php foreach($actividad as $ar) : ?>
               <p style="font-family: Montserrat; font-weight:800; font-size:10pt; text-align:center; margin-right:530px; margin-top:55px;"><?php foreach($responsable as  $act) : ?> <strong><?= $act->nombre ?>  <?= $act->apaterno?> <?= $act->amaterno ?> <hr width="98%"> </strong> promotor</p> <?php endforeach ?>
