      ...
      <header>
         ...
         <table  style="width:100%">
            <tr>
               ...
               <th rowspan="2">Formato de Resultado de Actividades <?php foreach($actividad as  $ar) : ?> <?php  if ( $ar->id_area == '1') echo 'Academica';
               if ( $ar->id_area == '2') echo 'Cultural y/o Deportiva';?></th><?php endforeach ?></th>
         ...
         <tbody>
            <?php foreach($alumnos as $key => $alumno) : ?>
               <tr>
                  ...
                  <td  id="alto" style="width: 15%; font-size:80%;"><?= $alumno['num_control']?></td>
