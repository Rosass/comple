<div class="container">
    <div class="row justify-content-center pt-5">
        <div class="col-md-6">
            <form method="post" action="<?= base_url('alumno/login') ?>" class="bg-light pr-4 pl-4 pt-5 pb-5 rounded border shadow-lg">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" id="num_control" placeholder="N. Control" name="num_control" required>
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <div class="input-group-text"><i class="fas fa-key"></i></div>
                    </div>
                    <input type="password" class="form-control" id="nip" placeholder="NIP" name="nip" required>
                </div>
