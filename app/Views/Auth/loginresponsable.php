<div class="container">
    <div class="row justify-content-center pt-5">
        <div class="col-md-6">
            <form method="post" action="<?= base_url('responsable/login') ?>" class="bg-light pr-4 pl-4 pt-5 pb-5 rounded border shadow-lg">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="rfc_responsable" placeholder="RFC" name="rfc_responsable" required>
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
