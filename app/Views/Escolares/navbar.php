    ...
    <div class="row pt-3">
		<div class="col-md-12">
			...
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded-bottom shadow-lg">
				<p class="navbar-brand text-wrap text-light" href="<?= base_url('escolares/inicio') ?>" style="font-size:15px !important;"><img src="<?= base_url('public/img/logotec_blanco.png') ?>" alt="" style="max-width: 30px;"> Sistema de Gestión de Actividades Complementarias</p>
