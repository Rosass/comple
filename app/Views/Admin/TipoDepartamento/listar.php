            ...
            <div class="table-responsive-sm text-center">
                <table class="table table-hover table-white table-striped shadow-lg" id="tablaTiposUsuarios">
                    <thead class="bg-color-tec-blue border-top-0 table-sm text-center text-white">
                        <tr>
                            <th scope="col" colspan="13" class="border-top-0 p-3"><h3 class="mb-0">TIPOS DE DEPARTAMENTOS</h3></th>
                        </tr>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td style="width:12%;">
                                    <div class="d-flex flex-column">
                                        <!--  Editar tipo-->
                                        <a class="btn btn-warning btn-sm btn-block mb-1" href="<?= base_url("admin/tipo-departamento/editar/".$tipo->id) ?>"><i class="fas fa-pen"></i> Editar</a>
                                            <!--  Mostrar botones si el tipo no es administrador  ( usando constante )-->                                       
                                            <?php if($tipo->estatus == true) : ?>
                                                <form action="<?= base_url('admin/tipo-departamento/cambiar-estatus') ?>" method="POST">
...
<?= view("Admin/TipoDepartamento/agregar"); ?>