...
<html lang="es">
   ...
   <body>
      ...
      <footer style="float: center;">
         ...
         <div> 
            <p style="font-family: Montserrat; font-weight:800; font-size:10pt; text-align:center; margin-right:550px;  margin-top:55px;"><?php foreach($actividad as  $act) : ?> <strong><?= $act->nombre_responsable ?>  <?= $act->apaterno?> <?= $act->amaterno ?> <hr width="95%"> </strong> promotor cultural o deportivo</p> <?php endforeach ?>
            <p style=" font-family: Montserrat; font-weight:800; font-size:10pt;  margin-left:5px; text-align:center; margin-top:-99px;"><strong><?= $ar->nombre_jefe ?> <?= $ar->apaterno_jefe?> <?= $ar->amaterno_jefe ?> <hr width="25%"></strong>jefe de oficina de promocion <br>Cultural o Deportiva </p>
            <p style=" font-family: Montserrat; font-weight:800; font-size:10pt;  margin-left:470px; text-align:center; margin-top:-99px;"><strong><?= $ar->nombre_jefe ?> <?= $ar->apaterno_jefe?> <?= $ar->amaterno_jefe ?> <hr width="70%"></strong> JEFE DE <?=  $ar->nombre_area ?></p> 
