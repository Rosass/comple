...
<div class="container text-center">
	<div class="row mt-5">
		<div class="col-md-12 ">
			...
			<?php endif ?>
			<form action="<?= base_url("alumno/inscripciones/editar") ?>" method="POST">
				<div class="card border-0 shadow-lg">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="number" class="form-control" name="telefono" value="<?= $inscripcion->telefono ?>">
								</div>
							</div>
						</div>
                        ...
                        <div class="text-center">
							...
							<a href="<?= base_url("alumno/inscripciones") ?>" class="btn btn-secondary" data-dismiss="modal">Cancelar</a>
