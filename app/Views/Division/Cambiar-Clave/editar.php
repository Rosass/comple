...
<div class="container text-center">
	<div class="row mt-5">
        ...
        <!-- Mensajes satisfactorios -->
                ...
                <?php endif ?>
                <form action="<?= base_url("division/cambiar-clave/editar-clave") ?>" method="POST">
                <div class="card border-0 shadow-lg">
					...
					<div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="clave2110981">NUEVA CLAVE (*)</label>
                                    <input type="password" class="form-control" name="clave2110981" id="clave2110981" required>
                                    <small id="msj5"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="confirmar_clave2110981">REPETIR NUEVA CLAVE (*)</label>
                                    <input type="password" class="form-control"  name="confirmar_clave2110981" id="confirmar_clave2110981" required>
                                    <small id="msj6"></small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
							...
							<a href="<?= base_url("division/cambiar-clave") ?>" class="btn btn-secondary" data-dismiss="modal">Cancelar</a>
