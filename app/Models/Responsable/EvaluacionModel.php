...
class EvaluacionModel extends Model
{
    ...
    public function get_evaluacion_desempenio($id_inscripcion)
	{
        ...
        return $this->db->table("evaluacion_desempenio ed")
            ->select("ed.id_inscripcion, ed.criterio1, ed.criterio2, ed.criterio3, ed.criterio4, ed.criterio5, ed.criterio6, ed.criterio7, ed.observaciones, ed.valor_numerico, ed.nivel_desempeno")
