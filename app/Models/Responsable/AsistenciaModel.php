...
class AsistenciaModel extends Model
{
	...
	{   
        ...
        ->select('insc.num_control, insc.id_inscripcion, act.id_actividad, act.nombre_actividad, e.valor_numerico as valor_numerico, e.nivel_desempeno as nivel_desempeno')
