...
class CambiarController extends BaseController
{
    ...
    {
        $this->cambiarService =  new \App\Services\Escolares\CambiarService();
    }
	...
	{  
        ...
        {   
            ...
            echo view('Escolares/navbar',  ["activo" => "cambiar clave"]);
            echo view('Escolares/Cambiar-Clave/editar', ["usuario" => $usuario]);
    ...
    public function actualizarClave()
    {
        ...
        {   
            ...
            if($respuesta["exito"])
            {
                ...
                return redirect('escolares/cambiar-clave');
            }
            else
            {
